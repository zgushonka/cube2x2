...
def show_cube_console(cube):
    ...
    print(left.tiles[0].color.value, left.tiles[1].color.value, front.tiles[0].color.value, \
    front.tiles[1].color.value, right.tiles[0].color.value, right.tiles[1].color.value)
    print(left.tiles[3].color.value, left.tiles[2].color.value, front.tiles[3].color.value, \
    front.tiles[2].color.value, right.tiles[3].color.value, right.tiles[2].color.value)
